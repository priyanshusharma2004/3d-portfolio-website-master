...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        "service_csgba3a",       // ✅ Your Gmail service ID
        "template_rmtmujp",      // ✅ Your EmailJS template ID
        form.current,
    ...
    <Container id="Contact">
      <Wrapper>
        ...
        <ContactForm ref={form} onSubmit={handleSubmit}>
          ...
          <ContactInput type="text" name="title" placeholder="Subject" required />
          <ContactInputMessage name="message" rows="4" placeholder="Your Message" required />
